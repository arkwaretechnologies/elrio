...
import { AreaChart, BarChart3, BookMarked, Clock, ClipboardList, History, Package, TrendingUp, Receipt, PackageSearch } from 'lucide-react';
...
const reportTabs = [
  ...
  { value: 'inventory-consumption', label: 'Inv. Consumption', icon: PackageSearch, href: '/super-admin/reports/inventory-consumption' },
